...
# -- Task 5: Arm B stop monitor (heartbeat for the freeze guard) ---------
# Lives in deploy\ecs\register_arm_b_monitor.ps1 so it can be (re)registered
# on a live box without re-running this whole script.
& "$REPO\deploy\ecs\register_arm_b_monitor.ps1"
